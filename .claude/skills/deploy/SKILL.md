...
6. `git push`
7. IF ON mimi/macOS: SSH to server and update: `ssh claw-rob 'openclaw plugins update superpack-snitch && sudo systemctl restart openclaw'`
8. Report the new version number and confirm server restart
